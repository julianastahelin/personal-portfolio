    ...
    return (
        ...
        >
            ...
            {content.cvSection.experiences.map((exp, index) => {
                return (
                    <div className='flex flex-col md:flex-row items-center md:items-stretch w-full gap-2 md:gap-7' key={exp+index}>
                        <h3 className='
            ...
            <div className='flex flex-col md:flex-row items-center md:items-stretch w-full gap-2 md:gap-7'>
                ...
                <div className='flex flex-col w-4/5 md:w-2/3 px-2 gap-5'>
                    {content.cvSection.abilities.list.map((type, index) => {
                        return (
            ...
            <div className='flex flex-col md:flex-row items-center md:items-stretch w-full gap-2 md:gap-7'>
                ...
                <div className='flex flex-col w-4/5 md:w-2/3 px-2 gap-5'>
                    <ul className='list-none pl-2'>
                        {
                            content.cvSection.languages.list.map((language, index) =>
            ...
            <div className='flex flex-col md:flex-row items-center md:items-stretch w-full gap-2 md:gap-7'>
                ...
                <div className='flex flex-col w-4/5 md:w-2/3 px-2 gap-5'>
                    <ul className='list-none pl-2'>
                        {
                            content.cvSection.links.list.map((link, index) =>
