...
title: Projects
projects:
  - title: The Image We Build of the City
    subtitle: "Photography exhibition by Sabrina Stahelin"
    stack:
      title: Technologies
      list:
        - Next.js
    ...
    description:
      title: Description
      text: "The website is a virtual photography exhibition designed to be accessible and responsive across all screen sizes. It features a virtual attendance list built using the Google Docs API, focusing on simplicity and low maintenance."
    links:
      title: Links
      list:
        - name: Website
          url: "https://www.imagemqueconstruimos.com.br/"
        - name: Repository
          url: "https://github.com/julianastahelin/imagem-que-construimos-da-cidade"
    images:
      desktop: imagem-que-construimos-desktop.gif
      tablet: imagem-que-construimos-tablet.gif
      mobile: imagem-que-construimos-mobile.gif
  - title: Duo Baobá
