...
experience:
  title: Experiência
  details:
    - name: "Desenvolvedora Front-end – Riachuelo/Financeira Midway"
      period: "out/25 – presente"
      description:
        - "Desenvolvimento de componentes escaláveis e reutilizáveis utilizando React e TypeScript"
        - "Construção de ferramentas dinâmicas para gerenciamento de conteúdo e criação de interfaces"
        - "Migração de aplicações para frameworks e bibliotecas modernas, com foco em funcionalidade e compatibilidade"
        - "Integração de aplicações front-end com APIs REST"
        - "Implementação de testes unitários com Jest e React Testing Library para garantia da qualidade e confiabilidade do código"
        - "Monitoramento de pipelines de CI/CD, com análise de falhas em processos de build e deploy"
    - name: "Desenvolvedora Front-end – Dynamox"
      period: "ago/24 – out/25"
      description:
